...
class NetworkUtilsV2TestCase(base.BaseTestCase):
    ...
    def test_create_vswitch_port(self):
        self.assertRaises(
            NotImplementedError,
            self.netutils.create_vswitch_port,
    ...
    @mock.patch.object(networkutilsv2.NetworkUtilsV2, '_is_port_vm_started')
    ...
    @mock.patch.object(networkutilsv2.NetworkUtilsV2, '_bind_security_rules')
...
class TestNetworkUtilsV2R2(base.BaseTestCase):

    def setUp(self):
        super(TestNetworkUtilsV2R2, self).setUp()
        self.netutils = networkutilsv2.NetworkUtilsV2R2()

    @mock.patch.object(networkutilsv2.NetworkUtilsV2R2,
                       '_get_default_setting_data')
